...
import cn.wrapper.layer_variables;

public abstract class layer extends layer_variables
{
    public abstract void forward(layer l, network network);
//    {
//    	System.err.println(" layer.forward(): "+this.getClass().getSimpleName());
//    }

  public abstract void backward(layer l, network network);
//  {
//	  System.err.println(" layer.backward(): "+this.getClass().getSimpleName());
//  }

  public abstract void update(layer l, Update_args update_args);
//  {
//	  System.err.println(" layer.update(): "+this.getClass().getSimpleName());
//  }
